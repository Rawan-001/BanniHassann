...
const DamDetailsPage = () => {
  ...
  if (!dam) return <Box sx={{ color: '#fff', textAlign: 'center', mt: 8 }}>لم يتم العثور على هذا السد.</Box>;
        ...
        {dam.images && dam.images.length > 0 && (
          <>
            ...
            {dam.images.length > 1 && (
              <>
                <IconButton
                  onClick={() => setCurrentImage((currentImage - 1 + dam.images.length) % dam.images.length)}
                  sx={{ 
                    position: 'absolute', 
                    top: '50%', 
                    left: { xs: 5, sm: 10 }, 
                ...
                <IconButton
                  onClick={() => setCurrentImage((currentImage + 1) % dam.images.length)}
                  sx={{ 
                    position: 'absolute', 
                    top: '50%', 
                    right: { xs: 5, sm: 10 }, 
