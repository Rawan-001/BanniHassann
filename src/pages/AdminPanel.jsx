...
export default function AdminPanel() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.title || !formData.googleMapsUrl) {
      setSnackbar({
        open: true,
        message: "يجب تعبئة العنوان والرابط بشكل إجباري.",
        type: "error",
      });
      return;
    }
          ...
          >
            <Box sx={{ textAlign: { xs: "center", md: "right" } }}>
              <Typography
                ...
                fontWeight="bold"
                color={colors.text}
                sx={{ mb: { xs: 0.5, md: 1 }, fontSize: { xs: "1.2rem", md: "2rem" } }}
              >
              ...
              <Typography
                ...
                sx={{ fontSize: { xs: "0.95rem", md: "1.1rem" }, mb: 0 }}
              >
