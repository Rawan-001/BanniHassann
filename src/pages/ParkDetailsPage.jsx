...
const ParkDetailsPage = () => {
  ...
  if (!park) return <Box sx={{ color: '#fff', textAlign: 'center', mt: 8 }}>لم يتم العثور على هذا المنتزه.</Box>;
        ...
        {park.images && park.images.length > 0 && (
          <>
            ...
            {park.images.length > 1 && (
              <>
                <IconButton
                  onClick={() => setCurrentImage((currentImage - 1 + park.images.length) % park.images.length)}
                  sx={{ 
                    position: 'absolute', 
                    top: '50%', 
                    left: { xs: 5, sm: 10 }, 
                ...
                <IconButton
                  onClick={() => setCurrentImage((currentImage + 1) % park.images.length)}
                  sx={{ 
                    position: 'absolute', 
                    top: '50%', 
                    right: { xs: 5, sm: 10 }, 
